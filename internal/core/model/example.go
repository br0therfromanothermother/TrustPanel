...
func WorkedExample() State {
	...
	return State{
		...
		RoutePolicies: []RoutePolicy{
			{
				ID: "keep-ru-here", Name: "Keep .ru on entry", Priority: 100, Tier: TierFleet,
		...
		Domains: []Domain{
			{ID: "d-entryA", Hostname: "cdn.example.com", Purpose: PurposeEndpoint, NodeID: "entryA", TLSStatus: "valid", CreatedAt: at, UpdatedAt: at},
		},
	}
}
