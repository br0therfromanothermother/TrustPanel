...
func usage() {
	fmt.Fprintln(os.Stderr, "usage: trustpanel bootstrap|serve|agent|ca|firewall|watchdog|promote|cluster|provision|bot|passwd|backup|restore|verify-restore|fallback|version [flags]")
	os.Exit(2)
}
